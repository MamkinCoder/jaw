...
try {
	...
	SELECT
		gender,
		AVG(CASE WHEN q12[1] = TRUE THEN 1 ELSE 0 END) as average_0,
		AVG(CASE WHEN q12[2] = TRUE THEN 1 ELSE 0 END) as average_1,
		AVG(CASE WHEN q12[3] = TRUE THEN 1 ELSE 0 END) as average_2,
		AVG(CASE WHEN q12 = '{f,f,f}'::boolean[] THEN 1 ELSE 0 END) as average_all_false
	FROM
        public.entry
	GROUP BY
		gender;
