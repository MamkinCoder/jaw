...
try {
	...
	SELECT
		gender,
		AVG(CASE WHEN q7[1] = TRUE THEN 1 ELSE 0 END) as average_0,
		AVG(CASE WHEN q7[2] = TRUE THEN 1 ELSE 0 END) as average_1,
		AVG(CASE WHEN q7[3] = TRUE THEN 1 ELSE 0 END) as average_2,
	FROM
        public.entry
	GROUP BY
		gender;
